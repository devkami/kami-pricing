...
from kami_pricing.async_scraper import AsyncScraper
...
class AsyncPricingManager:
    ...
    async def scraping_and_pricing(self) -> Tuple[pd.DataFrame, pd.DataFrame]:
        try:
            ...
            sellers_list = await sc.scrap_products_from_marketplace()
